        ...
        job = CoroutineScope(Dispatchers.IO).launch {
            ...
            try {
                ...
                withContext(Dispatchers.Main) {
                    ...
                    if (mensaje == "Usuario logeado") { // Cambia esto por tu condición
                        val intent = Intent(this@MainActivity, HomeActivity::class.java)
                        intent.putExtra("MESSAGE", "Aquí va el mensaje o dato a mostrar") // Mensaje para pasar a la nueva actividad
                        startActivity(intent)
                    } else {
                        Toast.makeText(this@MainActivity, "Respuesta del servidor: $mensaje", Toast.LENGTH_LONG).show()
                    }
                }
